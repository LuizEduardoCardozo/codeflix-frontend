...
import { TransictionSlide } from "../../Navbar/Transictions/TransictionSlide";
...
export const DialogMyAccount: React.FunctionComponent<DialogMyAccountProps> = (
    props
) => {
    ...
    return (
        <Dialog
            ...
            open={open} 
            onClose={handleClose} 
            TransitionComponent={TransictionSlide}
        >
